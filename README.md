...
We ran cross correlation of Attrition to all the possible variables and the values are tabulated below ![Figure 1](https://github.com/gpang98/Project_Predictive_Analytics_R/blob/main/Figure1_CrossCorrelation.jpg).  
