...
We ran cross correlation of Attrition to all the possible variables and the values are tabulated below ![Figure 1](https://github.com/gpang98/Project_Predictive_Analytics_R/blob/main/Figure1_CrossCorrelation.png).  None are above 0.5 meaning poor correlation between Attrition to any of these variables.  Almost all are negative values meaning they are inversely correlated.  OverTime has the highest positive value meaning the higher the OverTime (value are 1 for Yes and 0 for No) value, the higher likelihood of employees leaving the company.
